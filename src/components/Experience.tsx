...
export function Experience() {
  ...
  const drunkRef = useRef<Mesh>(null!)
  ...
  const { amplitude, frequency } = useControls('Drunk Effect', {
  ...
  return (
    <>
      ...
      <EffectComposer>
        ...
        /> */}
        {/* <SSR {...ssrProps} /> */}
        <Drunk ref={drunkRef} frequency={frequency} amplitude={amplitude} />
      </EffectComposer>
      ...
      <group ref={groupRef}>
        ...
        >
          ...
          {/* <meshBasicMaterial color={[1.5, 1, 4]} toneMapped={false} /> this is used to apply Bloom */}
        </mesh>
      </group>
